...
import { Zap, Users, Trophy, Sparkles, ArrowRight, Brain } from 'lucide-react';
import { styles, gradients, animations } from './styles/designSystems';
        ...
        <header className="container mx-auto px-6 py-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className={`w-10 h-10 bg-gradient-to-br ${gradients.css.primary} rounded-lg flex items-center justify-center`}>
            ...
            <button className={`px-6 py-2 ${styles.bg.glass} rounded-lg hover:bg-white/20 ${animations.transition.normal} border border-white/20`}>
        ...
        <main className="container mx-auto px-6 py-20">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
              ...
              <button className={`${styles.button.secondary} text-lg`}>
